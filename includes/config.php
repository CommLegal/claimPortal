...
if($_SERVER['SERVER_ADDR'] == "5.159.226.131") {
	$allowed = 0;
	$allowed_ips = array("OneCall" => "212.250.30.242", "NCI" => "188.39.142.171", "National Windscreens" => "88.98.181.29", "NEG" => "79.78.61.186", "Nationwide Windscreens" => "109.151.79.226", "Nationwide Windscreens 1" => "5.179.75.66");
