...
$userLogin = $conn->execute_sql("select", array("ul_id", "ul_username", "ul_forename", "ul_surname", "ul_company_title", "ul_breakdown", "ul_accident_recovery", "ul_fnol", "ul_windscreen", "ul_home_emergency", "ul_household_claim"), "user_login", "ul_username=LOWER(?)", array("s" => strtolower($_SESSION['userName'])));
...
<div class="container">   
	...
	if($_SESSION["userName"]) {
		...
		elseif($_REQUEST['displayPage'] == "windscreen") {
			?>
				<script src="<?php echo _ROOT ?>/js/jquery.jeditable.js"></script>
				<script src="<?php echo _ROOT ?>/js/jquery.jeditable.datepicker.js"></script>
			<?php
