...
$userLogin = $conn->execute_sql("select", array("ul_id", "ul_username", "ul_forename", "ul_surname", "ul_company_title", "ul_breakdown", "ul_accident_recovery", "ul_fnol"), "user_login", "ul_id=?", array("i" => $_COOKIE['userID']));
