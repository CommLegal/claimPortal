		...
		<div class="col-md-12">
                ...
                <div class="col-md-6">
                    ...
                    <h4>Previous Breakdowns</h4><div class="title-divider"></div>  
                    	<?php
						$previousBreakdowns = $conn->execute_sql("select", array('c_id, c_timestamp, bd_assisted_unassisted, bd_further_info'), "breakdown_assistance ON c_bd_id = bd_id", "bd_assisted_unassisted = 'Assisted' AND c_p_id = ?", array("i" => $policyInfo[0]['p_id']));
