            ...
            foreach ($policyInfo as $header => $value) {
                ...
                if ($_REQUEST['displayPage'] == "windscreen") {
                    ...
                    if($_SESSION['userID'] == 10) {
                        ...
                        if (in_array($policyDetail[0]['p_broker'], $brokerArray)) {
                            if ($policyDetail[0]['p_inception_date'] >= date("Y-m-d")) {
                                echo "<h4 style=\"clear:both; color: #ccc;\">Please refer the claim to National Windscreens 01827 338727</h4><div class=\"col-md-12 mb25\" style=\"height: 10px; background-color:#EBEBEB;\"></div>";
                                $ignore = 1;
                            }
                            unset($policyDetail[0]);
                        }                        
                    ...
                    if (in_array($policyDetail[0]['p_broker'], $brokerArray)) {
                        if ($policyDetail[0]['p_inception_date'] >= date("Y-m-d")) {
                            echo "<h4 style=\"clear:both; color: #ccc;\">Please refer the claim to XSD 03333 443 018</h4><div class=\"col-md-12 mb25\" style=\"height: 10px; background-color:#EBEBEB;\"></div>";
                            $ignore = 1;
                        }
                        unset($policyDetail[0]);
                    } 
