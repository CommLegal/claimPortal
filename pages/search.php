		...
		<div class="col-md-12">
                ...
                <div class="col-md-6">
                    <form id="hiddenClaimType" method="post" action="pages/accident_recovery_upload.php">
                        ...
                        <a id="passToNCI" class = "btn btn-default w100 mt25" PID="<?php echo $policyInfo[0]['p_id'] ?>" href="<?php echo $url . "?" . $fields_string ?>" target="_blank">Pass to NCI &nbsp;<i class="fa fa-lg fa-plus-circle"></i></a>
