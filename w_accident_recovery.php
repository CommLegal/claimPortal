...
<div class="container">
    ...
    <label>If the insurer is OIL show these buttons and show the FNOL Divs according to the selection.</label><br />
                ...
                <button type="button" class="btn btn-primary navbar-btn btn-lg mr5 col-md-3 unassist-btn" id="unassistedbutt">Unassisted <i class="fa fa-lg fa-arrow-right"></i></button>
    </div>
    </div>	
